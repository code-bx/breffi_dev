		...
		while($obItem = $res2->GetNextElement())
		{
			...
			if($arItem['PREVIEW_PICTURE']){
				...
				if(IntVal($arParams['MAX_WIDTH']) && IntVal($arParams['MAX_HEIGHT']))
					$arItem['PREVIEW_PICTURE']['TRUE_SIZE'] = RSDA2_GetProfiSize($arItem['PREVIEW_PICTURE']['WIDTH'], $arItem['PREVIEW_PICTURE']['HEIGHT'], $arParams['MAX_WIDTH'], $arParams['MAX_HEIGHT']);
			}
			if($arItem['DETAIL_PICTURE']){
				$arItem['DETAIL_PICTURE'] = CFile::GetFileArray($arItem['DETAIL_PICTURE']);
				if(IntVal($arParams['MAX_WIDTH']) && IntVal($arParams['MAX_HEIGHT']))
					$arItem['DETAIL_PICTURE']['TRUE_SIZE'] = RSDA2_GetProfiSize($arItem['DETAIL_PICTURE']['WIDTH'], $arItem['DETAIL_PICTURE']['HEIGHT'], $arParams['MAX_WIDTH'], $arParams['MAX_HEIGHT']);
			}
