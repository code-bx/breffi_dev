<?
$MESS['IBLOCK_ID_EMPTY'] = '(не выбрано)';
$MESS['IBLOCK_ID'] = 'Инфоблок';
$MESS['PRICE_CODE'] = 'Тип цены';
$MESS['CURRENCY_ID'] = 'Валюта для форматирования цены';
$MESS['PRICE_VAT_INCLUDE'] = 'Включать НДС в цену';
$MESS['SHOW_TYPE'] = '(для нескольких товаров дня) Отображать более поздние';
$MESS['PROPERTY_CODE'] = 'Выберите свойства для отображения вместо анонса';
$MESS['TEXT_OR_PROP'] = 'Выводить описание или свойства ИБ';
$MESS['DA_CHOSE1_TEXT'] = 'Текст';
$MESS['DA_CHOSE1_PROP'] = 'Свойства';
